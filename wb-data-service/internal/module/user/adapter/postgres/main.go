...
type PostgresManagerAdapter[T shared.UserModel] interface {
...
type _PostgresManagerAdapter[T shared.UserModel] struct {
	DatabaseManager domain.DatabaseManager
}

func NewPostgresManagerAdapter[T shared.UserModel](databaseManager domain.DatabaseManager) PostgresManagerAdapter[T] {
